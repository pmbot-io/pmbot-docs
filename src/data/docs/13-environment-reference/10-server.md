...
Host on which the Prometheus server should listen.

## PMBOT\_PROMETHEUS\_PORT
...
Port on which the Prometheus server should listen.

## PMBOT\_PROMETHEUS\_REFRESH\_RATE
...
Time (in seconds) between each Prometheus metrics refresh.

# PMBOT\_PROMETHEUS\_METRICS\_PREFIX

**Default**: pmbot_server_

**Type**: string

**Description**:

The prefix of Prometheus metrics generated by the server.
